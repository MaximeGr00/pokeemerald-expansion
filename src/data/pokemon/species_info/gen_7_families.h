...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_PIKIPEK] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = {  ABILITY_PICKUP,  ABILITY_SKILL_LINK,  ABILITY_FRISK },
    ...
    [SPECIES_TOUCANNON] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = {  ABILITY_SHEER_FORCE,  ABILITY_SKILL_LINK,  ABILITY_FRISK },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_FOMANTIS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_DAY, 30, SPECIES_LURANTIS},
    ...
    [SPECIES_ORANGURU] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = {  ABILITY_INNER_FOCUS,  ABILITY_SAGE_POWER,  ABILITY_TELEPATHY },
        .bodyColor = BODY_COLOR_WHITE,
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal, rzMode)          \
    ...
    [SPECIES_DRAMPA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_DRAGON),
        .abilities = {  ABILITY_BERSERK,  ABILITY_FATAL_PRECISION, ABILITY_SAP_SIPPER  },
        .bodyColor = BODY_COLOR_WHITE,
